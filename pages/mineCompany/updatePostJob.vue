	...
	<view class="post-job-container">
		...
		<view class="add-project-every">
			...
			<view class="every-input" style="display: flex;">
				...
				<view style="display: flex;">
					<input style="text-align: center;" placeholder="请输入" placeholder-style="color: #dadada;" type="text"
						v-model="postJobData.welfare" />
					<text>薪</text>
				</view>
			</view>
			<!-- <uni-popup ref="popupSalary" type="bottom">
				<view class="salary-container">
					<view class="salary-top">
						<text class="top-left">取消</text>
						<text class="top-center">薪资范围(月薪，单位：千元)</text>
						<text class="top-right">确定</text>
					</view>
		...
		<view class="add-project-button" @click="postJobClick">保存</view>
	</view>
</template>
